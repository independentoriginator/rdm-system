...
create or replace procedure 
	p_build_matview_emulation(
		i_view_rec ${mainSchemaName}.v_meta_view
		, i_partial_build text = null -- null or 'refresh procedure'
	)
language plpgsql
as $procedure$
declare 
...
begin
				...
				case 
					when t.view_query is not null then
						concat_ws(
							...
							, case 
								when i_partial_build is null then
									case 
							...
							, case 
								when i_partial_build is null
									or i_partial_build = 'refresh procedure'
								then
									case 
															...
															|| case 
																when i_view_rec.mv_emulation_with_partitioning then
																	format(
																		...
																		'\n	, string_agg('
																		'\n		i.new_partition_indexes'
																		'\n		, E'';\\n'''
																		'\n	) as new_partition_indexes_creating'
																		'\n	, string_agg('
																		'\n		format($ddl$'
																		'\n			truncate'
																		'\n				%I.%%I'
																		...
																		'\n				%I.%%I'
																		'\n			$ddl$'
																		'\n			, waste_partition.partition_table_name'
																		'\n		)'
																		'\n		, E'';\\n'''
																		'\n	) filter ('
																		'\n		where' 
																		'\n			waste_partition.partition_table_name is not null'
																		'\n	) as waste_partition_deleting'
																		'\ninto'
																		'\n	l_chunk_rec'
																		'\nfrom ('
																		'\n	select'
																		...
																		'\n		, case'
																		'\n			when partition0.partition_table_name is null then 0'
																		'\n			else 1'
																		'\n		end as new_partition_table_num'
																		'\n		, case'
																		'\n			when partition0.partition_table_name is null then chunk.partition_table1'
																		'\n			else chunk.partition_table0'
																		'\n		end as old_partition'
																		'\n		, case'
																		...
																		'\n) chunk'	
																		'\nleft join ${mainSchemaName}.v_sys_table_partition waste_partition'
																		'\n	on waste_partition.schema_name = chunk.schema_name'
																		'\n	and waste_partition.table_name = chunk.table_name'
																		'\n	and waste_partition.partition_expression ilike chunk.partition_expression'
																		'\n	and waste_partition.partition_table_name <> chunk.old_partition'
																		'\n	and waste_partition.partition_schema_name = chunk.schema_name'
																		'\nleft join lateral ('
																		'\n	select' 
																		'\n		string_agg('
																		'\n			format($ddl$'
																		...
																		'\n				, ${mainSchemaName}.f_compose_system_name('
																		'\n					i_name => chunk.table_name'
																		'\n					, i_postfix => '
																		'\n						format('
																		'\n							''%%s_%%s_idx%%s'''
																		'\n							, chunk.new_partition_table_num'
																		'\n							, chunk.sys_name'
																		'\n							, i.index_number'
																		'\n						)'																	
																		'\n				)'	
																		...
																		'\n			)'
																		'\n			, E'';\\n'''
																		'\n		) as new_partition_indexes'
																		'\n	from'
																		'\n		${mainSchemaName}.v_sys_table_index i'
																		'\n	where'
																		'\n		i.schema_name = chunk.schema_name'
																		'\n		and i.table_name = chunk.table_name'
																		'\n) i' 
																		'\n	on chunk.new_partition_table_id is null'
																		'\n;'
																		'\n'
																		'\nif l_chunk_rec.waste_partition_deleting is not null then'
																		'\n execute'
																		'\n 	l_chunk_rec.waste_partition_deleting'
																		'\n ;'
																		'\nend if'
																		'\n;'
																		...
																		'\n;'
																		'\nif l_chunk_rec.new_partition_indexes_creating is not null then'
																		'\n	execute'
																		'\n		l_chunk_rec.new_partition_indexes_creating'
																		'\n	;'
																		'\nend if'
																		'\n;'
																		'\nexecute'
	...
	if not l_is_matview_recognized then
		raise 
			'The materialized view %.% is not defined as it should be'
			, i_view_rec.schema_name
			, i_view_rec.internal_name
		; 
	end if
