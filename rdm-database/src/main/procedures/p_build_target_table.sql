		...
		if i_type_rec.is_temporal = false then
			execute format('
				create table %I.%I(
					...
					record_date timestamp without time zone default ${mainSchemaName}.f_current_timestamp() not null
				)'
			...
			execute format('
				create table %I.%I(
					...
					valid_from timestamp without time zone default ${mainSchemaName}.f_current_timestamp() not null,
